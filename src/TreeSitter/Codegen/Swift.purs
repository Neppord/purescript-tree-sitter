      ...
      { lhs ::
          Array
            ( Variant
                ...
                , open_start_range_expression :: Nopen_start_range_expression
...
newtype Nassignment = Nassignment
  { fields ::
      ...
      , target :: Variant (directly_assignable_expression :: Ndirectly_assignable_expression)
      }
  }

newtype Nassociatedtype_declaration = Nassociatedtype_declaration
  { children :: Array (Variant (modifiers :: Nmodifiers, type_constraints :: Ntype_constraints))
  , fields ::
      { default_value ::
          Array
            ( Variant
...
newtype Navailability_condition = Navailability_condition
  { children :: Array (Variant (identifier :: Nidentifier, integer_literal :: Ninteger_literal))
  , fields :: {}
  }
...
newtype Ncall_suffix = Ncall_suffix
  { children ::
      Array (Variant (lambda_literal :: Nlambda_literal, value_arguments :: Nvalue_arguments))
  , fields :: { name :: Array (Variant (simple_identifier :: Nsimple_identifier)) }
  }

newtype Ncapture_list = Ncapture_list
  { children :: Array (Variant (attribute :: Nattribute, capture_list_item :: Ncapture_list_item))
  , fields :: {}
  }
...
newtype Ncapture_list_item = Ncapture_list_item
  ...
  , fields ::
      { name :: Variant (self_expression :: Nself_expression, simple_identifier :: Nsimple_identifier)
      , value ::
          Array
            ( Variant
                ( additive_expression :: Nadditive_expression
...
newtype Ncatch_block = Ncatch_block
  { children ::
      Array
        ( Variant
            (catch_keyword :: Ncatch_keyword, statements :: Nstatements, where_clause :: Nwhere_clause)
        )
  , fields :: { error :: Maybe (Variant (binding_pattern :: Nbinding_pattern)) }
  }
  ...
  { children ::
      Array
        ( Variant
            ...
            , precedence_group_declaration :: Nprecedence_group_declaration
...
newtype Nclass_declaration = Nclass_declaration
  ...
  , fields ::
      { body :: Variant (class_body :: Nclass_body, enum_class_body :: Nenum_class_body)
      , declaration_kind :: Variant ()
      , name :: Variant (type_identifier :: Ntype_identifier, user_type :: Nuser_type)
      }
  }
...
newtype Ncomputed_getter = Ncomputed_getter
  { children ::
      Array
        ( Variant
            (attribute :: Nattribute, getter_specifier :: Ngetter_specifier, statements :: Nstatements)
        )
  , fields :: {}
  }
...
newtype Ncomputed_modify = Ncomputed_modify
  { children ::
      Array
        ( Variant
            (attribute :: Nattribute, modify_specifier :: Nmodify_specifier, statements :: Nstatements)
        )
  , fields :: {}
  }
...
newtype Nconstructor_expression = Nconstructor_expression
  ...
  , fields ::
      { constructed_type ::
          Variant
            (array_type :: Narray_type, dictionary_type :: Ndictionary_type, user_type :: Nuser_type)
      }
  }

newtype Nconstructor_suffix = Nconstructor_suffix
  { child :: Variant (lambda_literal :: Nlambda_literal, value_arguments :: Nvalue_arguments)
  , fields :: {}
  }
...
newtype Ndo_statement = Ndo_statement
  { children :: Array (Variant (catch_block :: Ncatch_block, statements :: Nstatements))
  , fields :: {}
  }
...
newtype Nenum_entry = Nenum_entry
  { child :: Maybe (Variant (modifiers :: Nmodifiers))
  , fields ::
      { data_contents :: Array (Variant (enum_type_parameters :: Nenum_type_parameters))
...
newtype Ngetter_specifier = Ngetter_specifier
  { children ::
      Array (Variant (async :: Nasync, mutation_modifier :: Nmutation_modifier, throws :: Nthrows))
  , fields :: {}
  }
...
newtype Nidentifier = Nidentifier
  { children :: Array (Variant (simple_identifier :: Nsimple_identifier)), fields :: {} }

newtype Nif_statement = Nif_statement
  { children ::
      Array (Variant (else :: Nelse, if_statement :: Nif_statement, statements :: Nstatements))
  , fields ::
      { condition ::
          Array
            ( Variant
...
newtype Nimport_declaration = Nimport_declaration
  { children :: Array (Variant (identifier :: Nidentifier, modifiers :: Nmodifiers)), fields :: {} }
...
newtype Ninheritance_specifier = Ninheritance_specifier
  { fields ::
      { inherits_from :: Variant (function_type :: Nfunction_type, user_type :: Nuser_type) }
  }
...
newtype Ninterpolated_expression = Ninterpolated_expression
  ...
  , fields ::
      ...
      , reference_specifier :: Array (Variant (simple_identifier :: Nsimple_identifier))
      , value ::
          Array
            ( Variant
                ( additive_expression :: Nadditive_expression
...
newtype Nlambda_function_type = Nlambda_function_type
  { children ::
      Array
        ( Variant
            ( async :: Nasync
            , lambda_function_type_parameters :: Nlambda_function_type_parameters
            , throws :: Nthrows
            )
        )
  , fields ::
...
newtype Nlambda_function_type_parameters = Nlambda_function_type_parameters
  { children :: Array (Variant (lambda_parameter :: Nlambda_parameter)), fields :: {} }
...
newtype Nlambda_literal = Nlambda_literal
  ...
  , fields ::
      ...
      , type :: Maybe (Variant (lambda_function_type :: Nlambda_function_type))
      }
  }
...
newtype Nlambda_parameter = Nlambda_parameter
  ...
  , fields ::
      { external_name :: Maybe (Variant (simple_identifier :: Nsimple_identifier))
      , name ::
          Array
            ( Variant
                ( array_type :: Narray_type
...
newtype Nline_string_literal = Nline_string_literal
  { fields ::
      { interpolation :: Array (Variant (interpolated_expression :: Ninterpolated_expression))
      , text ::
          Array (Variant (line_str_text :: Nline_str_text, str_escaped_char :: Nstr_escaped_char))
      }
  }
...
newtype Nmodify_specifier = Nmodify_specifier
  { child :: Maybe (Variant (mutation_modifier :: Nmutation_modifier)), fields :: {} }
...
newtype Nmulti_line_string_literal = Nmulti_line_string_literal
  { fields ::
      ...
      , text ::
          Array
            ( Variant
                (multi_line_str_text :: Nmulti_line_str_text, str_escaped_char :: Nstr_escaped_char)
            )
      }
  }
...
newtype Nnavigation_suffix = Nnavigation_suffix
  { fields ::
      { suffix ::
          Variant (integer_literal :: Ninteger_literal, simple_identifier :: Nsimple_identifier)
      }
  }
...
newtype Nopaque_type = Nopaque_type { child :: Variant (user_type :: Nuser_type), fields :: {} }
...
newtype Noperator_declaration = Noperator_declaration
  { children ::
      Array (Variant (custom_operator :: Ncustom_operator, simple_identifier :: Nsimple_identifier))
  , fields :: {}
  }
...
newtype Nparameter_modifiers = Nparameter_modifiers
  { children :: Array (Variant (parameter_modifier :: Nparameter_modifier)), fields :: {} }
...
newtype Nprecedence_group_attribute = Nprecedence_group_attribute
  { children ::
      Array (Variant (boolean_literal :: Nboolean_literal, simple_identifier :: Nsimple_identifier))
  , fields :: {}
  }

newtype Nprecedence_group_attributes = Nprecedence_group_attributes
  { children :: Array (Variant (precedence_group_attribute :: Nprecedence_group_attribute))
  , fields :: {}
  }
...
newtype Nprecedence_group_declaration = Nprecedence_group_declaration
  { children ::
      Array
        ( Variant
            ( precedence_group_attributes :: Nprecedence_group_attributes
            , simple_identifier :: Nsimple_identifier
            )
        )
  , fields :: {}
...
newtype Nprefix_expression = Nprefix_expression
  { fields ::
      { operation :: Variant (bang :: Nbang, custom_operator :: Ncustom_operator)
      , target ::
          Array
            ( Variant
                ( additive_expression :: Nadditive_expression
...
newtype Nproperty_declaration = Nproperty_declaration
  ...
  , fields ::
      { computed_value :: Array (Variant (computed_property :: Ncomputed_property))
      , name :: Array (Variant (value_binding_pattern :: Nvalue_binding_pattern))
      , value ::
          Array
            ( Variant
                ( additive_expression :: Nadditive_expression
  ...
  { children ::
      Array
        ( Variant
            ( associatedtype_declaration :: Nassociatedtype_declaration
            , deinit_declaration :: Ndeinit_declaration
            , protocol_function_declaration :: Nprotocol_function_declaration
            , protocol_property_declaration :: Nprotocol_property_declaration
            , subscript_declaration :: Nsubscript_declaration
            , typealias_declaration :: Ntypealias_declaration
            )
        )
  , fields ::
      { body :: Array (Variant (protocol_function_declaration :: Nprotocol_function_declaration)) }
  }
...
newtype Nprotocol_property_declaration = Nprotocol_property_declaration
  { children ::
      Array
        ( Variant
            ( modifiers :: Nmodifiers
            , protocol_property_requirements :: Nprotocol_property_requirements
            , type_annotation :: Ntype_annotation
            , type_constraints :: Ntype_constraints
            )
        )
  , fields :: { name :: Variant (value_binding_pattern :: Nvalue_binding_pattern) }
  }

newtype Nprotocol_property_requirements = Nprotocol_property_requirements
  { children ::
      Array (Variant (getter_specifier :: Ngetter_specifier, setter_specifier :: Nsetter_specifier))
  , fields :: {}
  }
...
newtype Nraw_str_interpolation = Nraw_str_interpolation
  { child :: Variant (raw_str_interpolation_start :: Nraw_str_interpolation_start)
  , fields ::
      { interpolation :: Array (Variant (interpolated_expression :: Ninterpolated_expression)) }
  }

newtype Nraw_string_literal = Nraw_string_literal
  { children :: Array (Variant (raw_str_continuing_indicator :: Nraw_str_continuing_indicator))
  , fields ::
      { interpolation :: Array (Variant (raw_str_interpolation :: Nraw_str_interpolation))
      , text :: Array (Variant (raw_str_end_part :: Nraw_str_end_part, raw_str_part :: Nraw_str_part))
      }
  }
...
newtype Ntuple_type = Ntuple_type
  { fields :: { element :: Array (Variant (tuple_type_item :: Ntuple_type_item)) } }

newtype Ntuple_type_item = Ntuple_type_item
  { children ::
      Array
        (Variant (parameter_modifiers :: Nparameter_modifiers, wildcard_pattern :: Nwildcard_pattern))
  , fields ::
      { name ::
          Array
            ( Variant
...
newtype Ntype_constraints = Ntype_constraints
  { children ::
      Array (Variant (type_constraint :: Ntype_constraint, where_keyword :: Nwhere_keyword))
  , fields :: {}
  }
...
newtype Ntype_parameters = Ntype_parameters
  { children :: Array (Variant (type_parameter :: Ntype_parameter)), fields :: {} }
...
newtype Nuser_type = Nuser_type
  { children ::
      Array (Variant (type_arguments :: Ntype_arguments, type_identifier :: Ntype_identifier))
  , fields :: {}
  }
...
newtype Nvalue_arguments = Nvalue_arguments
  { children :: Array (Variant (value_argument :: Nvalue_argument)), fields :: {} }

newtype Nvalue_binding_pattern = Nvalue_binding_pattern
  { child :: Variant (non_binding_pattern :: Nnon_binding_pattern), fields :: {} }
